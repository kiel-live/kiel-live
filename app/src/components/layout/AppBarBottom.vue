<template>
  <div
    class="flex w-full justify-center border-t-1 border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-dark-400 dark:text-gray-300"
  >
    <div class="flex w-full justify-around max-w-96">
      ...
      <router-link
        :to="{ name: 'favorites' }"
        class="flex flex-col items-center w-1/3 p-2"
        :class="{ 'text-blue-400': $route.name === 'favorites' }"
      ...
      <router-link
        :to="{ name: 'settings' }"
        class="flex flex-col items-center w-1/3 p-2"
        :class="{ 'text-blue-400': $route.name === 'settings' }"
