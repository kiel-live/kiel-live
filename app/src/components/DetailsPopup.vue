<template>
  ...
  <Transition v-else-if="isDesktop" name="fade">
    <div
      v-if="isOpen"
      class="absolute top-0 bottom-0 left-0 z-10 flex w-100 flex-col overflow-y-auto border-r border-gray-100 bg-white px-6 py-4 dark:border-neutral-950 dark:bg-neutral-800 dark:text-gray-300"
    >
      <slot />
    </div>
  </Transition>
